...
var S = {
  init: function (start) {
    if (start != 0){
      ...
      S.Drawing.init('.canvas', start);
      document.body.classList.add('body--ready'); 
      S.UI.simulate('|#countdown 3||祝|Hcir.|生日快乐|祝Hcir.生日快乐|今日是你的生日|我由衷的祝福你|愿你的世界|永远充满欢笑|愿你的内心|永葆善良|愿你能|早日考上驾照|混进了奇奇怪怪的祝福|(⌯꒪꒫꒪)੭|✧*｡ (ˊᗜˋ*) ✧*|不管奇不奇怪|都是我对你祝福|我想了半天|也没想到送啥好|最后只能|做张电子贺卡了|(っ◞‸◟c)|希望你不要嫌弃哦|就这样吧|黑羊奉上')
      S.Drawing.loop(function () {
        S.Shape.render();
      });
    }
